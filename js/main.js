...
function metrosAcentimetros(){ 
   ...
   var centimetros;
   var metros;
    num=parseInt(prompt("Por favor ingrese el valor en metros (m): "));
    metros= num;
    centimetros = metros*100;
    alert("En centimetros  es: " +  centimetros  + " (cm) y el valor dado en metros es: " +  metros + " (m)");
}
